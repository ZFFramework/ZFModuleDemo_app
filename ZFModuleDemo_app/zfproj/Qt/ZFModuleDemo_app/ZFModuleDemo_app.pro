...
macx {QMAKE_POST_LINK += install_name_tool -change "libZFModuleDemo_lib.1.dylib" "@rpath/libZFModuleDemo_lib.dylib" $$system_path($$DESTDIR/"$$TARGET".app/Contents/MacOS/$$ZF_PROJ_NAME) $$escape_expand(\\n\\t)}
