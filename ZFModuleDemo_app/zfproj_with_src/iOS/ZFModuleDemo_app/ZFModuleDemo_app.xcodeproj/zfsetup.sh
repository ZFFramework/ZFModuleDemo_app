...
sh $ZF_TOOLS_PATH/common/unity_build.sh "${COMPILE_DST_PATH}/zfgensrc_ZFModuleDemo_app.mm" "${iOS_SRCROOT}/../../../zfsrc"
...
sh $ZF_TOOLS_PATH/common/unity_build.sh "${COMPILE_DST_PATH}/zfgensrc_ZFModuleDemo_lib.mm" "$ZF_ROOT_PATH/../ZFModule/ZF/ZFModuleDemo_lib/zfsrc"
sh $ZF_TOOLS_PATH/common/unity_build.sh "${COMPILE_DST_PATH}/zfgensrc_ZFModuleDemo_impl.mm" "$ZF_ROOT_PATH/../ZFModule/ZF/ZFModuleDemo_impl/zfsrc"
...
sh "$ZF_TOOLS_PATH/util/copy_res.sh" "$ZF_ROOT_PATH/../ZFModule/ZF/ZFModuleDemo_lib/zfres" "$RES_DST_PATH"
sh "$ZF_TOOLS_PATH/util/copy_res.sh" "$ZF_ROOT_PATH/../ZFModule/ZF/ZFModuleDemo_impl/zfres" "$RES_DST_PATH"
