...
DEFINES += ZFLIB_ZFModuleDemo_lib=
DEFINES += ZFLIB_ZFModuleDemo_impl=
...
# ZF dependency
$$ZFAddLib($${ZF_ROOT_PATH}/ZF, 0, ZFCore)
$$ZFAddLib($${ZF_ROOT_PATH}/ZF, 0, ZFAlgorithm)
...
$$ZFAddLib($${ZF_ROOT_PATH}/ZF, 1, ZFUIKit_impl)
